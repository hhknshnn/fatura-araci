...
ULKE_CONFIG = {
    ...
    'jo': dict(inv_fmt=USD_FMT, grand_total='GRAND TOTAL USD', freight=False, excel_kur='usd', engine='usd_engine'),
    'mu': dict(inv_fmt=USD_FMT, grand_total='GRAND TOTAL USD', freight=False, excel_kur='usd', engine='usd_engine'),
